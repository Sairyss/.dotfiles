...
- try home row mods for some hold+key navigation actions (like described in [Modifier layers](#modifier-layers) section above) which works pretty great in kanata thanks to [tap-hold](https://github.com/jtroo/kanata/blob/v1.7.0/docs/config.adoc#tap-hold) feature.
